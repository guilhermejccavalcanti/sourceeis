...
public class PrettyPrinterASTTypes extends ASTVisitor {
	/**
	...
	/***
	 * A list containing the printed AST types.
	 */
	 ...
	 */
	public PrettyPrinterASTTypes() {
		this.buffer = new StringBuffer();
		this.types = new ArrayList<ASTNode>();
	}
	...
	/**
	 * Returns the types accumulated in the visit.
	 */
	...
	public boolean visit(MethodDeclaration node) {
		...
		if (!node.isConstructor()) {
			...
			this.buffer.append("ConstructorDeclaration\n");
		}
		return false;
	}
	...
	public boolean visit(TypeDeclaration node) {
		if(!node.getName().getIdentifier().equals("MISSING")){
			if (node.getJavadoc() != null) {
				node.getJavadoc().accept(this);
			}
			this.types.add(node);
